...
import { LogIn, User, Mail, AlertCircle, Eye, EyeOff } from 'lucide-react'
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-2.5 sm:py-3 border border-gray-300 rounded-md text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 pr-10 py-2.5 sm:py-3 border border-gray-300 rounded-md text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
